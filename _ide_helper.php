...
namespace Worksome\Exchange\Facades {
     ...
     */        class Exchange {
         ...
         * @static 
         */        public static function fake($rates = [])
        {
                        /** @var \Worksome\Exchange\Exchange $instance */
                        return $instance->fake($rates);
        }
                    /**
         * 
         *
         * @param \Worksome\Exchange\non-empty-array<int, string> $currencies
         * @throws InvalidCurrencyCodeException
         * @static 
         */        public static function rates($baseCurrency, $currencies)
        {
                        /** @var \Worksome\Exchange\Exchange $instance */
                        return $instance->rates($baseCurrency, $currencies);
        }
            }
    }
...
namespace  {
            ...
            class Exchange extends \Worksome\Exchange\Facades\Exchange {}
    }
